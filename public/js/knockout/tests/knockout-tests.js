...
function test_misc() {
    ...
    this.observableFactory = function (flag) {
...
function test_Components() {
    ...
    function test_Register() {
        ...
        var viewModelFn = function (params) { return null; };
        // ------- viewmodel overloads:
        ...
        ko.components.register("name", { template: "string-template", viewModel: { createViewModel: function (params, componentInfo) { return null; } } });
...
function test_tasks() {
    ...
    var logSomethingTask = function (message) {
        console.log("Log message");
        return true;
    };
    var taskHandle = ko.tasks.schedule(logSomethingTask);
    // Cancel a task
...
//# sourceMappingURL=knockout-tests.js.map